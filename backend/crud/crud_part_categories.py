...
def get_part_category(db: Session, part_category_id: int) -> PartCategory | None:
...
def get_part_category_by_name(db: Session, name: str) -> PartCategory | None:
...
def delete_part_category(db: Session, part_category_id: int) -> PartCategory | None:
