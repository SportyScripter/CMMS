...
class AttachmentBase(BaseModel):
    ...
    failure_id: int | None = Field(
        None,
        description="Link the file to a specific failure report.",
    )
    order_id: int | None = Field(
        None,
        description="Link the file to a scheduled maintenance order.",
    )
...
class AttachmentUpdate(BaseModel):
    ...
    failure_id: int | None = Field(
        None,
        description="Updated link to a failure report.",
    )
    order_id: int | None = Field(
        None,
        description="Updated link to a maintenance order.",
    )
