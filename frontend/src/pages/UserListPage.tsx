...
export const UserListPage = () => {
  ...
  // Renders the appropriate content inside the table container based on current application state
            ...
            {filteredUsers.map((user, index) => (
              <tr key={user.id} className="hover:bg-blue-50/50 transition-colors">
                ...
                <td className="px-6 py-4">
                  {user.is_active ? (
                    <span className="inline-flex items-center text-emerald-600">
                      <CheckCircle2 className="w-4 h-4 mr-1.5" /> Aktywny
                    </span>
                  ) : (
                    <span className="inline-flex items-center text-red-500">
                      <XCircle className="w-4 h-4 mr-1.5" /> Nieaktywny
                    </span>
                  )}
                </td>
                <td className="px-6 py-4 text-center">
                  ...
                  >
                    <Eye className="w-4 h-4 mr-1.5" /> Szczegóły
                  </button>
                </td>
              </tr>
            ))}
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex items-center mb-10 gap-10">
        <div className="flex items-center">
          ...
          >
            <ArrowLeft className="w-8 h-8 text-blue-400 hover:text-blue-600" />
          </Link>
          <div>
