...
export const MachineCreatePage = () => {
  ...
  const [status, setStatus] = useState("Sprawna");
      ...
      <div className="flex items-center mb-8">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600">
            Zarejestruj nowe urządzenie w systemie CMMS, nadając mu unikalny kod
            QR.
          </p>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 soace-y-6">
          {success && (
            <div className="flex items-center p-4 text-sm text-emerald-800 bg-emerald-50 rounded-lg">
              <CheckCircle2 className="w-5 h-5 mr-2" /> Pomyślnie zarejestrowano
              nową maszynę!
            </div>
          )}
          {error && (
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              >
                ...
                <option value="starting_up">W trakcie uruchomienia (Starting Up)</option>
              </select>
            </div>
          </div>
