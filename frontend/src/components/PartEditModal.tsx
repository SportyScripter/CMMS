...
import { X, Loader2, Wrench, Search, CheckCircle2 } from "lucide-react";
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none disabled:bg-gray-100 disabled:text-gray-500 bg-white"
                >
                  {categories.map((cat) => (
