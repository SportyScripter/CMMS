...
export interface Order {
  ...
  principal: { id: number; name: string; lastname: string , role: { id: number; name: string } };
  performed?: { id: number; name: string; lastname: string, role: { id: number; name: string } };
  checklist_items?: { id: number; task_description: string; status: string, comments: string }[];
}
